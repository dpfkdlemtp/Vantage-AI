...
CREATE TABLE tasks (
    ...
    module TEXT NOT NULL CHECK (module IN ('subdomain_enum', 'http_probe', 'domain_discovery', 'dir_enum', 'port_scan', 'banner_probe', 'cve_match', 'report')),
    tool TEXT NOT NULL,
    scope TEXT NOT NULL,
...
CREATE TABLE findings (
    ...
    run_id TEXT NOT NULL,
    task_id TEXT,
    module TEXT NOT NULL CHECK (module IN ('subdomain_enum', 'http_probe', 'domain_discovery', 'dir_enum', 'port_scan', 'banner_probe', 'cve_match', 'access_control')),
    target TEXT NOT NULL,
